...
const _fallbacks = <String, String>{
  ...
  'fulfilmentSla': 'Fulfilment SLA',
  'securityCompliance': 'Security and compliance',
  'fulfilmentWorkflow': 'Fulfilment workflow summary',
  'configureCatalogueParametersFirst':
      'Configure an active parameter before selecting a value.',
  'selectConfigurationItems': 'Select one or more configuration items.',
  'catalogueParameters': 'Catalogue parameters',
  'catalogueParametersDescription':
      'Maintain the selectable values used to design and publish IT services.',
  'catalogueCategories': 'Catalogue categories',
  'fulfilmentGroups': 'Fulfilment groups',
  'approvalPolicies': 'Approval policies',
  'catalogueLinkedConfiguration': 'Linked configuration',
  'manageWorkflowsFromCatalogue':
      'Create and publish service-request workflow versions.',
  'manageSlaFromCatalogue': 'Create and publish service-level policies.',
  'manageConfigurationItemsFromCatalogue':
      'Maintain the configuration items that underpin a service.',
  'addParameter': 'Add parameter',
  'edit': 'Edit',
  'noParameters': 'No active parameters',
  'addParameterToUseInCatalogue':
      'Add a value here before using it in a service catalogue item.',
  'deactivate': 'Deactivate',
  'deactivateParameter': 'Deactivate parameter',
